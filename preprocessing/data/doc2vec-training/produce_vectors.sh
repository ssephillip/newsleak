...
./doc2vecc -train $training_file_doc_only -word ./result/wordvectors.txt -output ./result/$result_vectors -cbow 1 -size 100 -window 10 -negative 5 -hs 0 -sample 0 -threads 4 -binary 0 -iter 20 -min-count 10 -test $training_file_doc_only -sentence-sample 0.1 -save-vocab ./result/alldata.vocab

echo "deleting false vectors"
