...
public class NerMicroservice extends JCasAnnotator_ImplBase {
	...
	public void process(JCas jcas) throws AnalysisEngineProcessException {
		StatsService.getInstance().addStatsEvent(StatsService.EVENT_TYPE_START, StatsService.NER);
		...
		StatsService.getInstance().addStatsEvent(StatsService.EVENT_TYPE_STOP, StatsService.NER);
	}
